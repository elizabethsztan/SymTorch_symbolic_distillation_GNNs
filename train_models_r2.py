...
"""
This script trains all the models on the r2 dataset. It is connected to wandb.
To run 
$ train_models_r2.py --save --wandb_log --epoch 100
"""
...
def main():
    ...
    model_type = 'pruning'
    model = create_model(model_type = model_type)
    model.edge_model.set_schedule(args.epoch, decay_rate='cosine', end_epoch_frac=0.65)
    model = train(model, train_data=train_data, val_data=val_data, dataset_name = 'r2', num_epoch=args.epoch,
                  save=args.save, wandb_log=args.wandb_log)
